  ...
  render() {
    return (
      <Paper className="pageStyle home">
        ...
        />
        <h1>
          Did you pay attention to today's news and think you know politics?
        </h1>
        <h1>Prove it!</h1>

        {this.state.noAvailableQuizzes ? (
          <p className="home-taken">
            You've taken all the quizzes we have available! Check back tomorrow
        ...
        <center style={{ marginBottom: "30px" }}>
          ...
          <YouTubePlayer className="youtube" url='https://www.youtube.com/watch?v=VHZJjDYnWMI' />
          <a
