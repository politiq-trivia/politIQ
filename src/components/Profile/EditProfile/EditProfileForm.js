      ...
      <div className="edit-profile">
        <form>
          ...
          <Select
            ...
            label="Affiliation"
            onChange={event =>
              this.handleChange("affiliation", event.target.value)
            }
            inputProps={{
              name: "affiliation"
            }}
        ...
        <div className="profile-button-holder">
          <Button color="primary" onClick={this.props.toggleEditProfile}>
            Cancel
          </Button>
          <Button color="primary" onClick={this.handleSave}>
            Save
          </Button>
          <Button color="primary" onClick={this.handleSaveAndView}>
