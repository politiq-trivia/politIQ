...
const CashOutReview = (props) => {
  ...
  const refetchAndUpdate = (updatedUserObj) => {
    localStorage.setItem('authUser', JSON.stringify(updatedUserObj)); // eslint-disable-line no-undef
...
CashOutReview.propTypes = {
  getCashOutRequests: PropTypes.func.isRequired,
